...
**Note:** This is not an officially supported tool, it's merely an idea on how the manifest
management and OCM usage can be done to simplify installations. This installer was completely
generated by AI and is not meant to be committed into any Platform Mesh repository.
